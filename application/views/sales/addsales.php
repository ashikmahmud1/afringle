                        ...
                        <div class="col-md-12 col-sm-9 col-xs-10">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="form-control" name="f_name" id="name" value="<?php echo set_value('f_name'); ?>" placeholder="Enter Story Title"/>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="form-label" for="field-3">Story Details</label>
                                    <div class="controls">
                                        <textarea name="address" placeholder="Address" class="form-control"  rows="4" ><?php echo set_value('address'); ?></textarea>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="form-label" for="field-3">Story Image</label>
                                    <div class="controls">
