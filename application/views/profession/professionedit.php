  ...
  <?php $this->load->view('inc/topnav'); ?>
	...
	<!-- Main content -->
		<div class="main-content">
			<h1 class="page-title">Please edit your profession from below option</h1>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="row">
                  ...
                  <form method="post" action="<?php echo base_url('profession/profession-edit'); ?>?id=<?php echo $UpdateData['id'] ?>">
                      <div class="col-md-12 col-sm-9 col-xs-10">
                          <div class="col-md-12">
                              <div class="form-group">
                                  <label class="form-label" for="field-1">Edit your hair color</label>
                                  <div class="controls">
