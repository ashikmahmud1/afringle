...
<div class="page-container">
  ...
  <div class="main-content">
     <h1 class="page-title">All your hair Profession is</h1>
...
<a  href="<?=base_url('profession/profession-edit?id='.$list['id']);?>"><i class="ui-tooltip fa fa-pencil info" style="font-size: 22px;margin-right: 15px;color: #3f51b5;" data-original-title="Edit"></i></a>
<a  onclick="return confirm('Are you sure remove this? #<?=$list['name'];?>')" href="<?=base_url('profession/profession-delete?id='.$list['id']);?>"><i class="ui-tooltip fa fa-trash-o" style="margin-right: 14px;color: red;font-size: 22px;" data-original-title="Delete"></i></a>
                             </td>
                         </tr>
