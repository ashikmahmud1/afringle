  ...
  <?php $this->load->view('inc/topnav'); ?>
	...
	<!-- Main content -->
		<div class="main-content">
			<h1 class="page-title">Please add your all tribes according to country wise below</h1>
    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="row">
                  <form action="<?=base_url('bo/Service/add_services');?>" method="post">

 			                <div class="col-md-12">
                        <div class="form-group">
                          <div class="col-md-3">
                              <label class="form-label" for="field-1">Choose Country Name</label>
                          </div>
                          <div class="col-md-9">
