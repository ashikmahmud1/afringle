...
<div class="page-container">
  ...
  <div class="main-content">
     <h1 class="page-title">Here is the list of all tribes added by you</h1>
                     ...
                     foreach($ListServices as $list):
                           ...
                           <tr role="row" class="gradeA">
                               ...
                               <td><?=$list['create_date'];?></td>
                                ...
                                <a  href="<?=base_url('service/edit-service?id='.$list['id']);?>"><i class="ui-tooltip fa fa-pencil info" style="font-size: 22px;margin-right: 15px;color: #3f51b5;" data-original-title="Edit"></i></a>
                               <a  onclick="return confirm('Are you sure remove this? #<?=$list['name'];?>')" href="<?=base_url('service/delete-service?id='.$list['id']);?>"><i class="ui-tooltip fa fa-trash-o" style="margin-right: 14px;color: red;font-size: 22px;" data-original-title="Delete"></i></a>
                               </td>
                           </tr>
