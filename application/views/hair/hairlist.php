                 ...
                 <tbody>
                    ...
                    ?>
                         ...
                         <tr role="row" class="gradeA">
                             <td><?=$list['hair_color'];?></td>

                              <td style="text-align: center;">
<a  href="<?=base_url('hair/hair-edit?id='.$list['id']);?>"><i class="ui-tooltip fa fa-pencil info" style="font-size: 22px;margin-right: 15px;color: #3f51b5;" data-original-title="Edit"></i></a>
<a  onclick="return confirm('Are you sure remove this? #<?=$list['hair_color'];?>')" href="<?=base_url('hair/hair-delete?id='.$list['id']);?>"><i class="ui-tooltip fa fa-trash-o" style="margin-right: 14px;color: red;font-size: 22px;" data-original-title="Delete"></i></a>
                             </td>
                         </tr>
