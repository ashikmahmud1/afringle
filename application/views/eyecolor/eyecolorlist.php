...
<div class="page-container">
  ...
  <div class="main-content">
     <h1 class="page-title">All your hair colors list is</h1>
           ...
           <div class="panel-body">
             <div class="table-responsive">
               <table class="table table-striped table-bordered table-hover dataTables-example" >
                 ...
                 <tbody>
                    <?php if(!empty($ListOfEyecolor)){


                    foreach($ListOfEyecolor as $list):
                    ?>
...
<a  href="<?=base_url('eyecolor/eyecolor-edit?id='.$list['id']);?>"><i class="ui-tooltip fa fa-pencil info" style="font-size: 22px;margin-right: 15px;color: #3f51b5;" data-original-title="Edit"></i></a>
<a  onclick="return confirm('Are you sure remove this? #<?=$list['name'];?>')" href="<?=base_url('eyecolor/eyecolor-delete?id='.$list['id']);?>"><i class="ui-tooltip fa fa-trash-o" style="margin-right: 14px;color: red;font-size: 22px;" data-original-title="Delete"></i></a>
</td>
                         </tr>
