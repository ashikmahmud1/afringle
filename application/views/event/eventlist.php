                 ...
                 <tbody>
                    ...
                    ?>
                         ...
                         <tr role="row" class="gradeA">
                             ...
                             <td><?=$list['event_start_date'];?></td>
                             <td><?=$list['event_end_date'];?></td>
                             <td><?=$list['event_price'];?></td>
                             <td><img src="<?=$list['event_image'];?>" class="img-responsive" width="250" height="150"></td>
                              <td style="text-align: center;">
<a  href="<?=base_url('event/event-edit?id='.$list['event_id']);?>"><i class="ui-tooltip fa fa-pencil info" style="font-size: 22px;margin-right: 15px;color: #3f51b5;" data-original-title="Edit"></i></a>
<a  onclick="return confirm('Are you sure remove this? #<?=$list['event_name'];?>')" href="<?=base_url('event/event-delete?id='.$list['event_id']);?>"><i class="ui-tooltip fa fa-trash-o" style="margin-right: 14px;color: red;font-size: 22px;" data-original-title="Delete"></i></a>
                             </td>
                         </tr>
