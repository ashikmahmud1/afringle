    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="row">
                  <form  action="<?php echo base_url('Story/editStory?id='.$StoryData['id']);?>" method="post" enctype="multipart/form-data">

                          <div class="col-md-12">

                             <div class="form-group">
                               <div class="col-md-3">
                                   <label class="form-label" for="field-1">Story Title</label>
                               </div>
                               <div class="col-md-9">
                                  <input type="text" class="form-control service_title" id="field-3" name="story_name"  value="<?=$StoryData['story_name']?>">
                             ...
                             <div class="form-group">
                               ...
                               <div class="col-md-9">
                                 ...
                                 <input type="hidden" name="oldstory_image" value="<?=$StoryData['story_image']?>">
                                   <div class="errorFN"></div>
                               </div>
                               <div class="clearfix"></div>
                             </div>
                             <div class="form-group">
                               <div class="col-md-3">
                                   <label class="form-label" for="field-1">Story Details</label>
                               </div>
                               <div class="col-md-9">
                                  <input type="text" name="story_details" class="form-control service_title" id="field-3" value="<?=$StoryData['story_details']?>" required>
                                   <div class="errorFN"></div>
                               </div>
                               <div class="clearfix"></div>
                             </div>
