...
<div class="page-container">
  ...
  <div class="main-content">
     <h1 class="page-title">All success stories</h1>
           ...
           <div class="panel-body">
			...
			?>
               ...
               <table class="table table-striped table-bordered table-hover dataTables-example" >
                 ...
                 <tbody>
                   <?php if(!empty($ListStory)){
                     foreach($ListStory as $list):
   					       ?>

                           <tr role="row" class="gradeA">
                               <td><?=$list['story_name'];?></td>
                               <td><img src="<?= $list['story_image'];?>" class="img-responsive" width="250"></td>
                               <td><?=$list['story_details'];?></td>
                               <td><?=$list['location'];?></td>
                               <td><?=$list['story_create_date'];?></td>
                                <td style="text-align: center;">
                                <a href="<?=base_url('Story/editStory?id='.$list['id']);?>"><i class="ui-tooltip fa fa-pencil info" style="font-size: 22px;margin-right: 15px;color: #3f51b5;" data-original-title="Edit"></i></a>
                                <a onClick="return confirm('Are you sure remove this? #<?=$list['story_name'];?>')" href="<?=base_url('Story/deleteStory?id='.$list['id']);?>"><i class="ui-tooltip fa fa-trash-o" style="margin-right: 14px;color: red;font-size: 22px;" data-original-title="Delete"></i></a>
                               </td>
                           </tr>
