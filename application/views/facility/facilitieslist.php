...
<body>
  ...
  <div class="main-content">
     <h1 class="page-title">List Of All Questions & Answers</h1>
                   ...
                   <?php if(!empty($ListServices)){
                      foreach($ListServices as $list): ?>
                           <tr role="row" class="odd">
                              ...
                              <td><?=$list['question2'];?></td>
                              <td><?=$list['question3'];?></td>
                              <td><?=$list['created_date'];?></td>
                              <td style="text-align: center;">
                              <a href="<?=base_url('facility/edit-facilitie?id='.$list['id']);?>"><i class="ui-tooltip fa fa-pencil info" style="font-size: 22px;margin-right: 15px;color: #3f51b5;" data-original-title="Edit"></i></a>
                              <a onClick="return confirm('Are you sure remove this? #<?=$list['facilitie_name'];?>')" href="<?=base_url('facility/delete-facilitie?id='.$list['id']);?>"><i class="ui-tooltip fa fa-trash-o" style="margin-right: 14px;color: red;font-size: 22px;" data-original-title="Delete"></i></a>
                            </td>
                           </tr>
                     <?php endforeach; } ?>
                 </tbody>
