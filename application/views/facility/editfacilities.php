  ...
  <div class="main-container">
	...
	<!-- Main content -->
		<div class="main-content">
			<h1 class="page-title">Edit Chemistry Question</h1>
    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
              <div class="row">
                  <form method="post" action="<?=base_url('Chemistry/Chemistry-update');?>" >
                      <div class="col-md-12 col-sm-9 col-xs-10">
                          <div class="col-md-12">
                              <div class="form-group">
                                  <label class="form-label" for="field-1">Question Title</label>
                                  <div class="controls">
                                      <input type="text" class="form-control" name="title" id="title" value="<?=$RowData['title'];?>" placeholder="Enter Question Title" required/>
                                      <input type="hidden"name="id" id="id" value="<?=$RowData['id'];?>" required/>
                          ...
                          <div class="col-md-12">
                              <div class="form-group">
                                  ...
                                  <div class="controls">
                                    <input type="text" class="form-control" name="question1" id="question1" value="<?=$RowData['question1'];?>" placeholder="Enter Question - 1" required/>
                          ...
                          <div class="col-md-12">
                              <div class="form-group">
                                  ...
                                  <div class="controls">
                                    <input type="text" class="form-control" name="question2" id="question1" value="<?=$RowData['question1'];?>" placeholder="Enter Question - 2" required/>
                          ...
                          <div class="col-md-12">
                              <div class="form-group">
                                  ...
                                  <div class="controls">
                                    <input type="text" class="form-control" name="question3" id="question3" value="<?=$RowData['question3'];?>" placeholder="Enter Question - 3" required/>
