...
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
              <div class="row">
                      <div class="col-md-12 col-sm-9 col-xs-10">
                        ...
                        <form method="post" action="<?=base_url('tax/tax-add');?>">
			<div class="col-md-12">
            ...
            <div class="col-md-9">
               <input type="text" name="tax_name" class="form-control" id="field-3" >
            ...
            <div class="col-md-9">
                <div class="controls">
                    <input type="number" name="tax_percentage" class="form-control" id="field-3" >
