           ...
           <div class="panel-body">
             <div class="table-responsive">
               <table class="table table-striped table-bordered table-hover dataTables-example" >
                 ...
                 <tbody>
                   <?php if(!empty($ListData)){ foreach($ListData as $list): ?>
                       ...
                       <tr role="row" class="gradeA">
                           ...
                           <td><?=$list['created_date'];?></td>
                            ...
                            <a  href="<?=base_url('tax/edit-tax?id='.$list['tax_id']);?>"><i class="ui-tooltip fa fa-pencil info" style="font-size: 22px;margin-right: 15px;color: #3f51b5;" data-original-title="Edit"></i></a>
                           <a  onclick="return confirm('Are you sure remove this? #<?=$list['tax_name'];?>')" href="<?=base_url('tax/delete-tax?id='.$list['tax_id']);?>"><i class="ui-tooltip fa fa-trash-o" style="margin-right: 14px;color: red;font-size: 22px;" data-original-title="Delete"></i></a>
                           </td>
                       </tr>
