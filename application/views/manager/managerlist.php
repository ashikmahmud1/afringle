                   ...
                   <?php if(!empty($ManagersList)){
     					...
     					?>
                             ...
                             <tr role="row" class="gradeA">
                                 ...
                                 <a  href="<?=base_url('manager/edit-manager?id='.$list['id']);?>"><i class="ui-tooltip fa fa-pencil info" style="font-size: 22px;margin-right: 15px;color: #3f51b5;" data-original-title="Edit"></i></a>
                                 <a  onclick="return confirm('Are you sure remove this? #<?=$list['firstname'].' '.$list['lastname']?>')" href="<?=base_url('manager/delete-manager?id='.$list['id']);?>"><i class="ui-tooltip fa fa-trash-o" style="margin-right: 14px;color: red;font-size: 22px;" data-original-title="Delete"></i></a>
                                 </td>
                             </tr>
