        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="row">
                  ...
                  <form method="post" action="<?php echo base_url('bodytype/bodytype-edit'); ?>?id=<?php echo $UpdateData['id'] ?>">
                      <div class="col-md-12 col-sm-9 col-xs-10">
                          <div class="col-md-12">
                              <div class="form-group">
                                  <label class="form-label" for="field-1">Edit your bodytype</label>
                                  <div class="controls">
                         ...
                         <div class="pull-right">
                              <button type="submit" class="btn btn-primary">Update bodytype</button>
                          </div>
                      </div>
                  </form>
