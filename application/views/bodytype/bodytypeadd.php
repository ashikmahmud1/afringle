  ...
  <?php $this->load->view('inc/topnav'); ?>
	...
	<!-- Main content -->
		<div class="main-content">
			<h1 class="page-title">Please add your all body type  here </h1>
    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="row">
                    <form method="post" action="<?php echo base_url('bodytype/bodytype-add'); ?>">
                        <div class="col-md-12 col-sm-9 col-xs-10">
                          <div class="col-md-12">
                              <div class="form-group">
                                  <label class="form-label" for="field-1">Put your body type</label>
                                  <div class="controls">
                           ...
                           <div class="pull-right">
                                <button type="submit" class="btn btn-primary">Save bodytype</button>
                            </div>
                        </div>
                    </form>
