  ...
  <?php $this->load->view('inc/topnav'); ?>
	...
	<!-- Main content -->
		<div class="main-content">
			<h1 class="page-title">Please Enter Here Content for Pay slip material.</h1>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="row">
                  ...
                  <form method="post" action="<?php echo base_url('slip/pay-slip'); ?>" enctype="multipart/form-data">
                      <div class="col-md-12 col-sm-9 col-xs-10">
                          <div class="col-md-12">
                              <div class="form-group">
                                  <label class="form-label" for="field-1">Enter Here Descriptions</label>
                                  <div class="controls">
                                      <input type="text" class="form-control" name="pay_slip" id="pay_slip" value="<?php echo $UpdatePaySlip['pay_slip'] ?>" />
                                        <input type="hidden" name="id" id="name" value="<?php echo $UpdatePaySlip['id'] ?>" />
                                        <?=form_error('pay_slip', '<div class="error">', '</div>');?>
                                  </div>
                              </div>
                          </div>
