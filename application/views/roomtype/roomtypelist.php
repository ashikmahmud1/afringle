             ...
             <div class="table-responsive">
               <table class="table table-striped table-bordered table-hover dataTables-example" >
                 ...
                 <tbody>
                    ...
                    foreach($ListRoomType as $list):
                    ?>

                         <tr role="row" class="gradeA">
                             <td><?=$list['room_type_name'];?></td>
                             <td><img src="<?=base_url('upload/room/'.$list['room_type_file']);?>" style="height:90px; width:80px;"></td>
                             <td><?=$list['created_date'];?></td>
                              <td style="text-align: center;">
                              <a  href="<?=base_url('roomtype/edit-room-type?id='.$list['room_type_id']);?>"><i class="ui-tooltip fa fa-pencil info" style="font-size: 22px;margin-right: 15px;color: #3f51b5;" data-original-title="Edit"></i></a>
                             <a  onclick="return confirm('Are you sure remove this? #<?=$list['room_type_name'];?>')" href="<?=base_url('roomtype/delete-room-type?id='.$list['room_type_id']);?>"><i class="ui-tooltip fa fa-trash-o" style="margin-right: 14px;color: red;font-size: 22px;" data-original-title="Delete"></i></a>
                             </td>
                         </tr>
