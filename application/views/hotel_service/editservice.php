    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="row">
                  <form method="post" action="<?=base_url('hotel_service/edit-service?id='.$ServiceData['id']);?>" enctype="multipart/form-data">
			<div class="col-md-12">
            ...
            <div class="col-md-9">
                ...
                <?php if(!empty($services)){
                   foreach($services as $service){?>
                           <option <?php echo set_select('service', $service['service_id']); ?> value="<?=$service['service_id']?>" <?php if($ServiceData['service_id'] == $service['service_id']){echo 'selected';}?>><?=$service['title']?></option>
                 <?php  }
                   }?>
                  </select>
            ...
            <div class="col-md-9">
                <div class="controls">
                     <textarea class="form-control" name="description" cols="5" id="field-6"><?=$ServiceData['description']?></textarea>
            ...
            <div class="col-md-9">
                <div class="controls">
                    <input type="number" name="price" class="form-control"   value="<?=$ServiceData['price']?>" id="field-3" >
            ...
            <div class="col-md-9">
                <div class="controls">
                    <input type="radio" name="status" <?php if($ServiceData['status'] == 'Published'){echo 'checked';}?> value="Published"> Public
                    <input type="radio" name="status" <?php if($ServiceData['status'] == 'Awaiting'){echo 'checked';}?>  value="Awaiting"> Private
                        ...
                        <select name="tax_type" class="form-control m-bot15">
                          <?php if(!empty($TaxType)){
              							foreach($TaxType as $list){?>
               						        <option <?php echo set_select('tax_type', $list['tax_id']); ?> value="<?=$list['tax_id']?>"   <?php if($ServiceData['tax_type'] == $list['tax_id']){echo 'selected';}?>   ><?=$list['tax_name'].' ('.$list['tax_percentage'].'%)'?></option>
              						<?php  }
              							}?>
                          </select>
