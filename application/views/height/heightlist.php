...
<div class="page-container">
  ...
  <div class="main-content">
     <h1 class="page-title">All your custom added Heights(in feet)</h1>
           ...
           <div class="panel-body">
             <div class="table-responsive">
               <table class="table table-striped table-bordered table-hover dataTables-example" >
                 ...
                 <tbody>
                    <?php if(!empty($ListOfHeight)){


                    foreach($ListOfHeight as $list):
                    ?>
...
<a  href="<?=base_url('height/height-edit?id='.$list['id']);?>"><i class="ui-tooltip fa fa-pencil info" style="font-size: 22px;margin-right: 15px;color: #3f51b5;" data-original-title="Edit"></i></a>
<a  onclick="return confirm('Are you sure remove this? #<?=$list['height'];?>')" href="<?=base_url('height/height-delete?id='.$list['id']);?>"><i class="ui-tooltip fa fa-trash-o" style="margin-right: 14px;color: red;font-size: 22px;" data-original-title="Delete"></i></a>
                             </td>
                         </tr>
