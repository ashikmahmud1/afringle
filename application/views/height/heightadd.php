  ...
  <?php $this->load->view('inc/topnav'); ?>
	...
	<!-- Main content -->
		<div class="main-content">
			<h1 class="page-title">Add height options (in feet)</h1>
    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="row">
                    <form method="post" action="<?php echo base_url('height/height-add'); ?>" enctype="multipart/form-data">
                        <div class="col-md-12 col-sm-9 col-xs-10">
                          <div class="col-md-12">
                              <div class="form-group">
                                  <label class="form-label" for="field-1">Enter Your Height Here (Like 6.1)</label>
                                  <div class="controls">
                                      <input type="text" class="form-control" name="height" id="name" value="" />
                           ...
                           <div class="pull-right">
                                <button type="submit" class="btn btn-primary">Add New Height</button>
                            </div>
                        </div>
                    </form>
