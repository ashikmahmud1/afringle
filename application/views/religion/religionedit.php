        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="row">
                  ...
                  <form method="post" action="<?php echo base_url('religion/religion-edit'); ?>" enctype="multipart/form-data">
                      <div class="col-md-12 col-sm-9 col-xs-10">
                          <div class="col-md-12">
                              <div class="form-group">
                                  <label class="form-label" for="field-1">Edit your religion</label>
                                  <div class="controls">
