...
<?php $this->load->view('inc/sidebar'); ?>
  ...
  <div class="main-content">
     <h1 class="page-title">Coupon Type List</h1>
   					...
   					?>
                           ...
                           <tr role="row" class="odd">
                               ...
                               <td><?=$list['created_date'];?></td>
                                ...
                                <a  href="<?=base_url('couponcode/edit-couponcode?id='.$list['coupon_id']);?>"><i class="ui-tooltip fa fa-pencil info" style="font-size: 22px;margin-right: 15px;color: #3f51b5;" data-original-title="Edit"></i></a>
                               <a  onclick="return confirm('Are you sure remove this? #<?=$list['coupon_name'];?>')" href="<?=base_url('couponcode/delete-couponcode?id='.$list['coupon_id']);?>"><i class="ui-tooltip fa fa-trash-o" style="margin-right: 14px;color: red;font-size: 22px;" data-original-title="Delete"></i></a>
                               </td>
                           </tr>
