			   ...
			   "<div class='modal-dialog'>" +
                 "<div class='modal-content'>" +
					"<div class='modal-header'>" +
					  ...
					  "<h4 class='modal-title title'>" + locale.link.insert + "</h4>" +
					"</div>" +
					"<div class='modal-body'>" +
					  "<input class='form-control' value='http://' class='bootstrap-wysihtml5-insert-link-url input-xlarge'>" +
					  "<div class='checkbox'><label> <input type='checkbox' class='bootstrap-wysihtml5-insert-link-target' checked>" + locale.link.target + "</label></div>" +
					"</div>" +
              ...
              "<div class='bootstrap-wysihtml5-insert-image-modal modal fade'>" +
			   "<div class='modal-dialog'>" +
                "<div class='modal-content'>" +
					"<div class='modal-header'>" +
					  "<a class='close' data-dismiss='modal'>&times;</a>" +
					  "<h4 class='modal-title title'>" + locale.image.insert + "</h4>" +
					"</div>" +
					"<div class='modal-body'>" +
